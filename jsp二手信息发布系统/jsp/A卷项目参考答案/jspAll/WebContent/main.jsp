...
<!--[if lt IE 9]>
<script type="text/javascript" src="css/lib/html5.js"></script>
<script type="text/javascript" src="css/lib/respond.min.js"></script>
<![endif]-->
<link rel="stylesheet" type="text/css"
	href="css/static/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css"
	href="css/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css"
	href="css/lib/Hui-iconfont/1.0.8/iconfont.css" />
<link rel="stylesheet" type="text/css"
	href="css/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css"
	href="css/static/h-ui.admin/css/style.css" />
<!--[if IE 6]>
...
<body>
				...
				<nav id="Hui-userbar"
					...
					<ul class="cl">
						...
						<li class="dropDown dropDown_hover"><a href="#"
							class="dropDown_A">${username.name} <i class="Hui-iconfont">&#xe6d5;</i></a>
							<ul class="dropDown-menu menu radius box-shadow">
		...
		<div class="Hui-article">
			<article class="cl pd-20">
				...
				<table class="table table-border table-bordered table-bg">
					<thead>
						<tr>
							<th colspan="7" scope="col">成绩统计</th>
						</tr>
						<tr class="text-c">
							<th>id</th>
							<th>sid</th>
	...
	<script type="text/javascript"
		src="css/static/h-ui.admin/js/H-ui.admin.page.js"></script>
	<!--/_footer /作为公共模版分离出去-->
